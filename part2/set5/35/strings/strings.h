...
class Strings
{
    ...
    public:
        ...
        Strings(Strings const &other) = default;            // automatically
        Strings(Strings &&tmp) = default;                   // done, but
        Strings &operator=(Strings const &other) = default; // added for 
        Strings &operator=(Strings &&tmp) = default;        // clarity
