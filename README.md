...
Each set will be handled in a specific branch, ranging from setX for part 1 to
p2sX for part 2, and when part 3 comes around we will keep that convention.
