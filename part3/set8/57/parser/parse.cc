// Generated by Bisonc++ V6.09.02 on Mon, 20 Apr 2026 16:21:38 +0200
...
PI_ const s_productionInfo[] = 
{
     ...
     {269, 2}, // 4: line (errTok_) ->  errTok_ '\x0a'
     {269, 1}, // 5: line ('\x0a') ->  '\x0a'
     {269, 1}, // 6: line (EXIT) ->  EXIT
     {269, 1}, // 7: line (LIST) ->  LIST
     {270, 1}, // 8: expr (NUMBER) ->  NUMBER
     {270, 1}, // 9: expr (IDENT) ->  IDENT
     {270, 2}, // 10: expr (uMinus) ->  '-' expr
     {270, 3}, // 11: expr ('+') ->  expr '+' expr
     {270, 3}, // 12: expr ('-') ->  expr '-' expr
     {270, 3}, // 13: expr ('*') ->  expr '*' expr
     {270, 3}, // 14: expr ('/') ->  expr '/' expr
     {270, 3}, // 15: expr ('%') ->  expr '%' expr
     {270, 3}, // 16: expr (SHIFTLEFT) ->  expr SHIFTLEFT expr
     {270, 3}, // 17: expr (SHIFTRIGHT) ->  expr SHIFTRIGHT expr
     {270, 3}, // 18: expr ('&') ->  expr '&' expr
     {270, 3}, // 19: expr ('^') ->  expr '^' expr
     {270, 3}, // 20: expr ('|') ->  expr '|' expr
     {270, 3}, // 21: expr ('(') ->  '(' expr ')'
     {270, 3}, // 22: expr ('=') ->  expr '=' expr
     {270, 3}, // 23: expr (ADDIS) ->  expr ADDIS expr
     {270, 3}, // 24: expr (SUBIS) ->  expr SUBIS expr
     {270, 3}, // 25: expr (MULIS) ->  expr MULIS expr
     {270, 3}, // 26: expr (DIVIS) ->  expr DIVIS expr
     {271, 1}, // 27: lines_$ ->  lines
};
