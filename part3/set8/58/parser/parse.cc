// Generated by Bisonc++ V6.09.02 on Tue, 07 Apr 2026 19:48:04 +0200
...
PI_ const s_productionInfo[] = 
{
     ...
     {260, 2}, // 4: line (errTok_) ->  errTok_ '\x0a'
     {260, 1}, // 5: line ('\x0a') ->  '\x0a'
     {261, 1}, // 6: expr (NUMBER) ->  NUMBER
     {261, 2}, // 7: expr (uMinus) ->  '-' expr
     {261, 3}, // 8: expr ('+') ->  expr '+' expr
     {261, 3}, // 9: expr ('-') ->  expr '-' expr
     {261, 3}, // 10: expr ('*') ->  expr '*' expr
     {261, 3}, // 11: expr ('/') ->  expr '/' expr
     {262, 1}, // 12: lines_$ ->  lines
};
