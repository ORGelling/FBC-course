// Generated by Bisonc++ V6.09.02 on Wed, 15 Apr 2026 02:04:47 +0200
...
PI_ const s_productionInfo[] = 
{
     ...
     {269, 1}, // 6: line (errTok_) ->  errTok_
     {269, 1}, // 7: line ('\x0a') ->  '\x0a'
     {270, 3}, // 8: var ('=') ->  ident '=' expr
     {273, 1}, // 9: ident (IDENT) ->  IDENT
     {271, 1}, // 10: fun (FUNCNAME) ->  FUNCNAME
     {272, 1}, // 11: expr (NUMBER) ->  NUMBER
     {272, 1}, // 12: expr (IDENT) ->  IDENT
     {272, 1}, // 13: expr (FUNCNAME) ->  FUNCNAME
     {272, 2}, // 14: expr (uMinus) ->  '-' expr
     {272, 2}, // 15: expr (uMinus) ->  '+' expr
     {272, 3}, // 16: expr ('+') ->  expr '+' expr
     {272, 3}, // 17: expr ('-') ->  expr '-' expr
     {272, 3}, // 18: expr ('*') ->  expr '*' expr
     {272, 3}, // 19: expr ('%') ->  expr '%' expr
     {272, 3}, // 20: expr ('/') ->  expr '/' expr
     {272, 3}, // 21: expr ('(') ->  '(' expr ')'
     {272, 3}, // 22: expr (ADDIS) ->  expr ADDIS expr
     {272, 3}, // 23: expr (SUBIS) ->  expr SUBIS expr
     {272, 3}, // 24: expr (MULIS) ->  expr MULIS expr
     {272, 3}, // 25: expr (DIVIS) ->  expr DIVIS expr
     {274, 1}, // 26: lines_$ ->  lines
};
