// Generated by Bisonc++ V6.09.02 on Wed, 15 Apr 2026 20:01:17 +0200
...
PI_ const s_productionInfo[] = 
{
     ...
     {260, 2}, // 1: rules ->  rules rule
     {260, 0}, // 2: rules ->  <empty>
     {261, 4}, // 3: rule (IDENT) ->  IDENT ':' alternatives ';'
     {262, 1}, // 4: alternatives ->  alternative
     {262, 3}, // 5: alternatives ('|') ->  alternatives '|' alternative
     {263, 2}, // 6: alternative ->  symbols prec
     {264, 2}, // 7: symbols ->  symbols symbol
     {264, 0}, // 8: symbols ->  <empty>
     {266, 1}, // 9: symbol (IDENT) ->  IDENT
     {266, 1}, // 10: symbol (CHAR) ->  CHAR
     {265, 2}, // 11: prec (PREC) ->  PREC IDENT
     {265, 0}, // 12: prec ->  <empty>
     {267, 1}, // 13: rules_$ ->  rules
};
...
#line 34 "grammar"
        {
         d_val_ = RuleValue(std::vector<std::vector<std::string>>{ vs_(0).symbols });
         }
        break;
...
#line 39 "grammar"
        {
         d_val_ = vs_(-2);
         d_val_.alternatives.push_back(vs_(0).symbols);
         }
        break;
...
#line 47 "grammar"
        {
         d_val_ = vs_(-1);
         d_val_.symbols.push_back(vs_(0).text);
         }
        break;
