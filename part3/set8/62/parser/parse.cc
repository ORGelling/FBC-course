// Generated by Bisonc++ V6.09.02 on Wed, 15 Apr 2026 19:43:16 +0200
...
PI_ const s_productionInfo[] = 
{
     ...
     {262, 1}, // 4: alternatives ->  alt
     {262, 3}, // 5: alternatives ('|') ->  alternatives '|' alt
     {263, 2}, // 6: alt ->  symbols prec
...
#line 27 "grammar"
        {
         ...
         for (auto const &rhs: vs_(-1).alternatives)
         d_rules.push_back(Rule{vs_(-3).text, rhs});
         }
        break;
