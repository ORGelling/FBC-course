// Generated by Bisonc++ V6.09.02 on Mon, 13 Apr 2026 18:44:18 +0200
...
PI_ const s_productionInfo[] = 
{
     ...
     {261, 3}, // 1: lines ('\x0a') ->  lines '\x0a' line
     {261, 0}, // 2: lines ->  <empty>
     {262, 1}, // 3: line (INT) ->  INT
     {262, 1}, // 4: line (STRING) ->  STRING
     {262, 1}, // 5: line (DOUBLE) ->  DOUBLE
     {262, 1}, // 6: line (QUIT) ->  QUIT
     {262, 1}, // 7: line ('\x0a') ->  '\x0a'
     {263, 1}, // 8: lines_$ ->  lines
};
...
#line 26 "grammar"
        {
         showString(vs_(0).get<Tag_::STRING>());
         }
        break;
...
#line 31 "grammar"
        {
         showDouble(vs_(0).get<Tag_::DOUBLE>());
         }
        break;
