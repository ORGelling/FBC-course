// Generated by Bisonc++ V6.09.02 on Tue, 21 Apr 2026 14:38:52 +0200
...
PI_ const s_productionInfo[] = 
{
     ...
     {267, 2}, // 1: lines ->  lines line
     {267, 1}, // 2: lines ->  line
     {268, 2}, // 3: line ('\x0a') ->  expr '\x0a'
     {268, 2}, // 4: line (errTok_) ->  errTok_ '\x0a'
     {268, 1}, // 5: line (EXIT) ->  EXIT
     {268, 2}, // 6: line (RAD) ->  RAD '\x0a'
     {268, 2}, // 7: line (DEG) ->  DEG '\x0a'
     {268, 2}, // 8: line (GRAD) ->  GRAD '\x0a'
     {268, 1}, // 9: line ('\x0a') ->  '\x0a'
     {269, 2}, // 10: expr (uMinus) ->  '-' expr
     {269, 3}, // 11: expr ('+') ->  expr '+' expr
     {269, 3}, // 12: expr ('-') ->  expr '-' expr
     {269, 3}, // 13: expr ('(') ->  '(' expr ')'
     {269, 3}, // 14: expr ('=') ->  expr '=' expr
     {269, 1}, // 15: expr (E_CONST) ->  E_CONST
     {269, 1}, // 16: expr (PI_CONST) ->  PI_CONST
     {269, 1}, // 17: expr (NUMBER) ->  NUMBER
     {269, 1}, // 18: expr (IDENT) ->  IDENT
     {269, 4}, // 19: expr ('(') ->  funcname '(' arg_list ')'
     {270, 1}, // 20: funcname (FUN) ->  FUN
     {271, 0}, // 21: arg_list ->  <empty>
     {271, 1}, // 22: arg_list ->  expr
     {271, 3}, // 23: arg_list (',') ->  arg_list ',' expr
     {272, 1}, // 24: lines_$ ->  lines
};
...
#line 124 "grammar"
        {
         d_val_ = callFunction(vs_(-3).d_name, *vs_(-1).d_args);
         }
        break;
...
#line 143 "grammar"
        {
         d_val_ = RuleValue::arglist();
         d_val_.d_args->push_back(valueOf(vs_(0)));
         }
        break;
...
#line 149 "grammar"
        {
         vs_(-2).d_args->push_back(valueOf(vs_(0)));
         d_val_ = vs_(-2);
         }
        break;
