// Generated by Flexc++ V2.17.01 on Sun, 29 Mar 2026 00:18:51 +0100
...
protected:
    ...
    int     const (*d_dfaBase_)[6];

    static int     const s_dfa_[][6];
    static int     const (*s_dfaBase_[])[6];
