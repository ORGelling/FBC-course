// Generated by Bisonc++ V6.09.02 on Tue, 31 Mar 2026 22:56:08 +0200
...
PI_ const s_productionInfo[] = 
{
     ...
     {258, 0}, // 1: list ->  <empty>
     {258, 2}, // 2: list (WORD) ->  WORD sequence
     {259, 0}, // 3: sequence ->  <empty>
     {259, 1}, // 4: sequence ->  plain
     {259, 1}, // 5: sequence ->  separated
     {260, 1}, // 6: plain (WORD) ->  WORD
     {260, 2}, // 7: plain (WORD) ->  plain WORD
     {261, 2}, // 8: separated (',') ->  ',' WORD
     {261, 3}, // 9: separated (',') ->  separated ',' WORD
     {262, 1}, // 10: list_$ ->  list
};
