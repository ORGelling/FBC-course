// Generated by Bisonc++ V6.09.02 on Wed, 01 Apr 2026 19:24:36 +0200
...
PI_ const s_productionInfo[] = 
{
     ...
     {258, 2}, // 1: input ('\x0a') ->  prompt '\x0a'
     {258, 4}, // 2: input ('\x0a') ->  prompt command '\x0a' input
     {260, 2}, // 3: command ('m') ->  'm' DOUBLE
     {260, 2}, // 4: command ('s') ->  's' DOUBLE
     {260, 2}, // 5: command (DOUBLE) ->  DOUBLE score
     {261, 0}, // 6: score ->  <empty>
     {261, 1}, // 7: score (DOUBLE) ->  DOUBLE
     {259, 0}, // 8: prompt ->  <empty>
     {262, 1}, // 9: input_$ ->  input
};
