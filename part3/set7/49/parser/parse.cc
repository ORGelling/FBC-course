// Generated by Bisonc++ V6.09.02 on Fri, 03 Apr 2026 21:40:13 +0200
...
PI_ const s_productionInfo[] = 
{
     ...
     {260, 0}, // 1: input ->  <empty>
     {260, 2}, // 2: input ->  input expr
     {261, 4}, // 3: expr (WRITE) ->  WRITE '(' write_contents ')'
     {262, 0}, // 4: write_contents ->  <empty>
     {262, 1}, // 5: write_contents ->  write_element_list
     {263, 1}, // 6: write_element_list ->  write_element
     {263, 3}, // 7: write_element_list (',') ->  write_element_list ',' write_element
     {264, 1}, // 8: write_element (IDENT) ->  IDENT
     {264, 1}, // 9: write_element (NUMBER) ->  NUMBER
     {265, 1}, // 10: input_$ ->  input
};
...
{
    { { REQ_DEF}, {  6} },                      
    { {     262}, {  5} }, // write_contents    
    { {     263}, {  6} }, // write_element_list
    { {     264}, {  7} }, // write_element     
    { {     258}, {  8} }, // IDENT             
    { {     259}, {  9} }, // NUMBER            
    { {       0}, { -4} },                      
