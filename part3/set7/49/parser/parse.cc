// Generated by Bisonc++ V6.09.02 on Mon, 30 Mar 2026 23:16:39 +0200
...
PI_ const s_productionInfo[] = 
{
     ...
     {261, 3}, // 3: expr (WRITE) ->  WRITE write_contents ')'
     {262, 0}, // 4: write_contents ->  <empty>
     {262, 1}, // 5: write_contents ->  write_element
     {262, 3}, // 6: write_contents (',') ->  write_element ',' write_contents
     {263, 1}, // 7: write_element (IDENT) ->  IDENT
     {263, 1}, // 8: write_element (NUMBER) ->  NUMBER
     {264, 1}, // 9: input_$ ->  input
};
