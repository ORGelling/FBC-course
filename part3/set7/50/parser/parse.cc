// Generated by Bisonc++ V6.09.02 on Wed, 01 Apr 2026 18:11:44 +0200
...
PI_ const s_productionInfo[] = 
{
     ...
     {258, 0}, // 1: input ->  <empty>
     {258, 2}, // 2: input ->  input line
     {259, 1}, // 3: line ('\x0a') ->  '\x0a'
     {259, 2}, // 4: line ('\x0a') ->  exp '\x0a'
     {260, 1}, // 5: exp (NUMBER) ->  NUMBER
     {260, 2}, // 6: exp ('-') ->  '-' exp
     {260, 3}, // 7: exp ('+') ->  exp '+' exp
     {260, 3}, // 8: exp ('-') ->  exp '-' exp
     {260, 3}, // 9: exp ('*') ->  exp '*' exp
     {260, 3}, // 10: exp ('/') ->  exp '/' exp
     {260, 3}, // 11: exp ('^') ->  exp '^' exp
     {260, 2}, // 12: exp ('$') ->  '$' exp
     {260, 3}, // 13: exp ('(') ->  '(' exp ')'
     {261, 1}, // 14: input_$ ->  input
};
